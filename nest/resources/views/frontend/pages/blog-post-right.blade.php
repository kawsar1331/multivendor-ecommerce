...
@section('main-content')
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html">Recipes</a> <span></span> Best smartwatch 2022: the top wearables you can buy today
                </div>
            </div>
        </div>
    ...
    <img src="{{asset('frontend')}}/assets/imgs/blog/blog-19.png" alt="" />
    </figure>
    ...
    <div class="row">
        <div class="col-xl-10 col-lg-12 m-auto">
            ...
            <img class="mb-30" src="{{asset('frontend')}}/assets/imgs/blog/blog-21.png" alt="" />
    ...
    <div class="author-bio p-30 mt-50 border-radius-15 bg-white">
        <div class="author-image mb-30">
            <a href="author.html"><img src="{{asset('frontend')}}/assets/imgs/blog/author-1.png" alt="" class="avatar" /></a>
