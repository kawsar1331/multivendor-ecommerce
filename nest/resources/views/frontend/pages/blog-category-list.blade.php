                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="loop-grid loop-list pr-30 mb-50">
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-1.png)">
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-2.png)"></div>
                                <div class="entry-content-2 pl-50">
                                    <h3 class="post-title mb-20">
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-3.png)">
                                    <div class="entry-meta">
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-4.png)">
                                    <div class="entry-meta">
                                        <a class="entry-meta meta-2" href="blog-category-grid.html"><i class="fi-rs-play-alt"></i></a>
                                    </div>
                                </div>
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-5.png)">
                                    <div class="entry-meta">
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-6.png)"></div>
                                <div class="entry-content-2 pl-50">
                                    <h3 class="post-title mb-20">
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-1.png)"></div>
                                <div class="entry-content-2 pl-50">
                                    <h3 class="post-title mb-20">
                                        <a href="blog-post-right.html">9 Tasty Ideas That Will Inspire You to Grow a Home Herb Garden Today</a>
                                    </h3>
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                <div class="post-thumb" style="background-image: url({{asset('frontend')}}/assets/imgs/blog/blog-7.png)">
                                    <div class="entry-meta">
